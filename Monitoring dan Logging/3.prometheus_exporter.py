...
THROUGHPUT = Counter(
    "http_requests_throughput", "Total number of requests per second"
)  # Throughput
ERROR_COUNT = Counter(
    "http_requests_error_total", "Total number of failed requests"
)  # Jumlah error
SUCCESS_COUNT = Counter(
    "http_requests_success_total", "Total number of successful requests"
)  # Jumlah sukses
REQUEST_SIZE = Histogram(
    "http_request_size_bytes", "Size of HTTP request payload (bytes)"
)  # Ukuran request
RESPONSE_SIZE = Histogram(
    "http_response_size_bytes", "Size of HTTP response payload (bytes)"
)  # Ukuran response
